         ...
         <span style="color: red; text-shadow: 1px 1px 2px black, 0 0 25px blue, 0 0 5px darkblue; font-size: 30px;">
            <table>
                <tr>
                    ...
                    <td>Dear </td><td><?php echo $_GET["firstname"]; ?>&nbsp;
                    <?php echo $_GET["lastname"]; ?></td></tr>
                <tr><td>Email :</td> <td><?php echo $_GET["email"]; ?></td></tr><br>
                   <tr><td>Mobile No:</td><td><?php echo $_GET["tel"]; ?></td> 
                </tr>
             </table>
             ...
             <br>
             <br>
             Your data has been Submitted<br><br>Our representative will contact you soon.....</span><br> <br>
       
                    
           <input type="submit" value="Go Back" onclick="contact_us.php">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
         &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
